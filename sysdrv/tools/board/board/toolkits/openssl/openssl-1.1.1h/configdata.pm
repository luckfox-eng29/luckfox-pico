...
our %config = (
  ...
  ARFLAGS => [ "r" ],
  CC => "gcc",
  CFLAGS => [ "-march=armv7-a -mfpu=neon -mfloat-abi=hard -march=armv7-a -mfpu=neon -mfloat-abi=hard -march=armv7-a -mfpu=neon -mfloat-abi=hard -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -Os -I /home/cro/Sdk/luckfox-pico/sysdrv/tools/board/toolkits/openssl/../zlib/out/include -L /home/cro/Sdk/luckfox-pico/sysdrv/tools/board/toolkits/openssl/../zlib/out/lib -mthumb -Wa,-mimplicit-it=thumb -mthumb-interwork" ],
  CPPDEFINES => [  ],
  CPPFLAGS => [ "-march=armv7-a -mfpu=neon -mfloat-abi=hard -march=armv7-a -mfpu=neon -mfloat-abi=hard -march=armv7-a -mfpu=neon -mfloat-abi=hard -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -Os -I /home/cro/Sdk/luckfox-pico/sysdrv/tools/board/toolkits/openssl/../zlib/out/include -L /home/cro/Sdk/luckfox-pico/sysdrv/tools/board/toolkits/openssl/../zlib/out/lib -mthumb -Wa,-mimplicit-it=thumb -mthumb-interwork" ],
  CPPINCLUDES => [  ],
  CROSS_COMPILE => "arm-rockchip830-linux-uclibcgnueabihf-",
  CXX => "g++",
  CXXFLAGS => [ "-march=armv7-a -mfpu=neon -mfloat-abi=hard -march=armv7-a -mfpu=neon -mfloat-abi=hard -march=armv7-a -mfpu=neon -mfloat-abi=hard -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -Os -I /home/cro/Sdk/luckfox-pico/sysdrv/tools/board/toolkits/openssl/../zlib/out/include -L /home/cro/Sdk/luckfox-pico/sysdrv/tools/board/toolkits/openssl/../zlib/out/lib -mthumb -Wa,-mimplicit-it=thumb -mthumb-interwork" ],
  HASHBANGPERL => "/usr/bin/env perl",
  LDFLAGS => [ "-march=armv7-a -mfpu=neon -mfloat-abi=hard -march=armv7-a -mfpu=neon -mfloat-abi=hard -march=armv7-a -mfpu=neon -mfloat-abi=hard -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -Os -I /home/cro/Sdk/luckfox-pico/sysdrv/tools/board/toolkits/openssl/../zlib/out/include -L /home/cro/Sdk/luckfox-pico/sysdrv/tools/board/toolkits/openssl/../zlib/out/lib -mthumb -Wa,-mimplicit-it=thumb -mthumb-interwork" ],
  ...
  prefix => "/home/cro/Sdk/luckfox-pico/sysdrv/tools/board/toolkits/openssl/out",
  processor => "",
